...
if(isset($_POST['post1'])){
    $i = $tempArray['FileyTale_amd64'] +1;
    $tempArray['FileyTale_amd64'] = $i ;
...
if(isset($_POST['post3'])){
    $i = $tempArray['FileyTale_x64'] +1;
    $tempArray['FileyTale_x64'] = $i ;
...
if(isset($_POST['post5'])){
    $i = $tempArray['FileyTale_x86'] +1;
    $tempArray['FileyTale_x86'] = $i ;
